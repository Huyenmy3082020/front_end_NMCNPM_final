    ...
    const handleAddOrderProduct = async () => {
        if (user?.id) {
            ...
            try {
                ...
                const result = await Cartservice.creataCart({ cartData, access_token });
                        ...
                        <div className={styles.wrapperRight}>
                            <div className={styles.wrapperList}>
                                <div className={styles.wrapperImg}>
                                    <div>
                                        <img
                                            className={styles.wrapperImgBig}
                                    ...
                                    >
                                        <a href="" className={styles.wrapperImgLink}>
                                            <img
                                                src={`http://localhost:2000${products.image}`}
                                                className={styles.wrapperImgSmall}
                                                alt=""
                                            />
                                        </a>
                                        <a href="" className={styles.wrapperImgLink}>
                        ...
                        <div className={styles.wrapperCenter}>
                            <div className={styles.wrapperList}>
                                <div>
                                    ...
                                    <p className={styles.wrapperProductName}>{products.description}</p>
                            ...
                            <div className={styles.wrapperList}>
                                ...
                                <div className={styles.stylesname}>
                                    <span className={styles.nameKey}>Brand</span>
                                    <span className={styles.nameValue}>{products.brand}</span>
                                </div>
                                {products.customDetails &&
                                    products.customDetails.map((item, index) => (
                                        <div className={styles.stylesname} key={item._id || index}>
                                            <span className={styles.nameKey}>{item.key}</span>
                                            <span className={styles.nameValue}>{item.value}</span>
                                        </div>
                                    ))}

                                {products.dimensions &&
                                    Object.keys(products?.dimensions)?.map((key) => (
                                        <div className={styles.stylesname} key={key}>
                                            <span className={styles.nameKey}>{key}</span>
                                            <span className={styles.nameValue}>{products.dimensions[key]}</span>
                                        </div>
                                    ))}
                            </div>
                        </div>
