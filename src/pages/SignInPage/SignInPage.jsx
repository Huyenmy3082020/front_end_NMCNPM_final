            ...
            { email, password },
            {
                onSuccess: (data) => {
                    ...
                    if (data?.accessToken) {
                        ...
                        console.error('Login succeeded but no access token received.');
                    }
                },
                onError: (error) => {
                    setIsLoading(false);
                    ...
                    if (error.response && error.response.data) {
                        ...
                        if (error.response.status === 500) {
                            setErrorMessage('Đã xảy ra lỗi từ server. Vui lòng thử lại sau!');
                        } else {
                            setErrorMessage(message || 'Đã xảy ra lỗi bất ngờ');
                        }
                    } else {
                        setErrorMessage('Đã xảy ra lỗi bất ngờ');
                    }
                },
            },
        );
