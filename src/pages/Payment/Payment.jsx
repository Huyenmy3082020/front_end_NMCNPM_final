...
function Payment() {
    ...
    console.log(location.state.orderItems.quantity);
    const handleAddOrder = async () => {
        if (location.state.ship?.address) {
            try {
                const orderData = {
                    ...
                    user: user?.id,
                    shippingAddress: location.state.ship,
                    totalQuantiy: location.state.quantity,
                    paymentMethos: selectedPaymentDescription,
                };
                                                    ...
                                                    <div className={styles.PaymentWrapper} key={cartItem.productId}>
                                                        ...
                                                        <div className={styles.PaymentWrapperLeft}>
                                                            ...
                                                            <div style={{ display: 'flex', alignItems: 'center' }}>
                                                                <div>
                                                                    <img
                                                                        src={`http://localhost:2000${cartItem.image}`}
                                                                        width="48px"
                                                                        height="48px"
                                                                        alt=""
                                                                    />
                        ...
                        <Col span={6}>
                            <div className={styles.wrapperRight}>
                                ...
                                <div style={{ paddingTop: '8px' }}>
                                    <span>
                                        {location.state?.ship?.city} {location.state.ship.district}
                                        {location.state?.ship?.ward}
                                    </span>
                                </div>
                                <div style={{ paddingTop: '8px', color: 'rgb(128, 128, 137)', paddingBottom: '16px' }}>
                                    <span>
                                        ...
                                        >
                                            Nhà {location.state.ship.address}
                                        </span>
                                        {user?.address}
                                    </span>
                                </div>
