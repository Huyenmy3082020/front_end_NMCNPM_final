...
import { updateShipInfo } from '../../redux/slides/ShipSlide';
function OrderPage() {
    ...
    useEffect(() => {
        const fetchShippingData = async () => {
            try {
                const res = await Cartservice.getCartById(user?.id, cartId);
                console.log(res);
                dispatch(updateShipInfo(res));
                                        ...
                                        <div style={{ display: 'flex', alignItems: 'center' }}>
                                            <div style={{ marginLeft: '6px' }}>
                                                <img
                                                    width="80px"
                                                    height="80px"
                                                    src={`http://localhost:2000${orderItem.image}`}
                                                    alt=""
                                                />
                                            </div>
